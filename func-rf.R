...
rf.rolling.window=function(Y,nprev,indice=1,lag=1){
  ...
  return(list("pred"=save.pred,"errors"=errors,"save.importance"=save.importance, "model"=model)) #return forecasts, history of variable importance, and RMSE and MAE for the period.
}
